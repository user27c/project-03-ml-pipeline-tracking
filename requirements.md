...
- [x] 成功从CSV摄取100K+记录
- [x] 从公共API获取数据（例如OpenML、Kaggle API）
- [x] 从PostgreSQL数据库查询数据
- [x] 使用重试优雅地处理网络错误
- [x] 记录所有摄取活动
...
- [ ] Docker Compose文件已创建
- [ ] 所有服务成功启动
- [ ] MLflow UI可在<http://localhost:5000访问>
- [ ] Airflow UI可在<http://localhost:8080访问>
- [ ] MinIO控制台可在<http://localhost:9001访问>
